...
int main()
{
	...
	while(1)
    {
        ...
        cleardevice();
        //readimagefile("night.jpg", 0, 0, 900, 540);
       ...
       // for(rec=0; rec<5; rec++)
        ...
        //{
            ...
            setcolor(BLUE);
            rectangle(250+i*5,10,275+i*5,18);
            setfillstyle(SOLID_FILL,BLUE);
            floodfill(270+i*5,13,BLUE);
            setcolor(RED);
            rectangle(0+i*5,3,15+i*5,9);
            setfillstyle(SOLID_FILL,RED);
            floodfill(1+i*5,5,RED);
            setcolor(5);
